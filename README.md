...
1. Download `SmartPlayer_v1.X.X.X.ndpkg` from the [Releases](https://github.com/NSTechBytes/SmartPlayer/releases) page.
...
- `SmartPlayer_v1.X.X.X.ndpkg` — Novadesk package
- `SmartPlayer_v1.X.X.X.zip` — Widget package
